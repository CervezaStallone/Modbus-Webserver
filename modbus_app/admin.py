...
class ModbusInterfaceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("name", "protocol", "enabled")}),
        (
            "RTU Configuration",
            {
        ...
        (
            "TCP Configuration",
            {"fields": ("host", "tcp_port"), "classes": ("collapse",)},
        ),
        (
            "Connection Settings",
...
class RegisterAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("device", "name", "enabled")}),
        (
        ...
        ("Conversion", {"fields": ("conversion_factor", "conversion_offset", "unit")}),
        ("Permissions", {"fields": ("writable",)}),
        (
            "Metadata",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class DashboardWidgetAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Layout", {"fields": ("column_position", "row_position", "width", "height")}),
        (
            "Trend Configuration",
            {
                "fields": (
