...
def interface_add_view(request):
    ...
    return render(
        request,
        "config/interface_form.html",
        {"title": "Interface Toevoegen", "action": "add"},
    )
...
def interface_edit_view(request, pk):
    ...
    return render(
        request,
        "config/interface_form.html",
        {"title": "Interface Bewerken", "action": "edit", "interface_id": pk},
    )
...
def device_add_view(request):
    ...
    return render(
        request,
        "config/device_form.html",
        {"title": "Device Toevoegen", "action": "add"},
    )
...
def device_edit_view(request, pk):
    ...
    return render(
        request,
        "config/device_form.html",
        {"title": "Device Bewerken", "action": "edit", "device_id": pk},
    )
...
def register_add_view(request):
    ...
    return render(
        request,
        "config/register_form.html",
        {"title": "Register Toevoegen", "action": "add"},
    )
...
def register_edit_view(request, pk):
    ...
    return render(
        request,
        "config/register_form.html",
        {"title": "Register Bewerken", "action": "edit", "register_id": pk},
    )
...
def alarm_list_view(request):
    ...
    return render(request, "config/alarms.html", {"title": "Alarm Configuratie"})


@login_required
def template_list_view(request):
    """Device template list view."""
    return render(request, "config/templates.html", {"title": "Device Templates"})
...
class DeviceViewSet(viewsets.ModelViewSet):
    ...
    def apply_template(self, request, pk=None):
        ...
        if not template_id:
            return Response(
                {"status": "error", "message": "template_id is verplicht"},
                status=status.HTTP_400_BAD_REQUEST,
            )
        ...
        try:
            ...
            return Response(
                {"status": "error", "message": "Template niet gevonden"},
...
class RegisterViewSet(viewsets.ModelViewSet):
    ...
    def read_now(self, request, pk=None):
        ...
        try:
            ...
            if raw_value is None:
                return Response(
                    {"status": "error", "message": "Kon register niet lezen"},
                    status=status.HTTP_400_BAD_REQUEST,
                )
    ...
    def write_value(self, request, pk=None):
        ...
        if not register.is_writable:
            return Response(
                {"status": "error", "message": "Dit register is niet schrijfbaar"},
                status=status.HTTP_400_BAD_REQUEST,
            )
        ...
        if value is None:
            return Response(
                {"status": "error", "message": "value is verplicht"},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def trend_data(self, request, pk=None):
        ...
        if interval:
            ...
            data = TrendDataAggregated.objects.filter(
                register=register, interval=interval, timestamp__gte=start_time
            ).order_by("timestamp")
...
class AlarmViewSet(viewsets.ModelViewSet):
    ...
    def acknowledge(self, request, pk=None):
        ...
        if not history_entry:
            return Response(
                {"status": "error", "message": "Geen actief alarm gevonden"},
                status=status.HTTP_404_NOT_FOUND,
            )
