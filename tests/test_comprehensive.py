...
from modbus_app.models import (
    ...
    DeviceTemplate, CalculatedRegister
)
...
class AlarmTests(BaseTestCase):
    ...
    def test_alarm_history_creation(self):
        ...
        history = AlarmHistory.objects.create(
            alarm=alarm,
            trigger_value=75.0
        )
...
class DashboardTests(BaseTestCase):
    ...
    def test_create_dashboard_widget(self):
        ...
        response = self.api_client.post('/api/v1/dashboard-widgets/', data, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
...
class DeviceTemplateTests(BaseTestCase):
    ...
    def test_create_device_template(self):
        ...
        response = self.api_client.post('/api/v1/device-templates/', data, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
...
class IntegrationTests(BaseTestCase):
    ...
    def test_complete_workflow(self):
        ...
        response = self.api_client.post('/api/v1/dashboard-widgets/', widget_data, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
