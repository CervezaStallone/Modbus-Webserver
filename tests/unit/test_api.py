...
from modbus_app.models import ModbusInterface, Device, Register, TrendData, Alarm
...
class TestInterfaceAPI:
    ...
    def test_update_interface(self, admin_user, modbus_interface_rtu):
        ...
        response = client.put(f'/api/v1/interfaces/{modbus_interface_rtu.id}/', data, format='json')
        assert response.status_code == status.HTTP_200_OK
