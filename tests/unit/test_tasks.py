...
from modbus_app.models import Device, Register, TrendData, CalculatedRegister
...
class TestPollDeviceRegisters:
    ...
    def test_poll_device_success(self, mock_broadcast_device, mock_broadcast_register, 
                                 mock_get_service, device, register):
...
class TestHealthCheck:
    ...
    def test_health_check_interfaces(self, mock_broadcast, mock_get_manager, modbus_interface_rtu):
